...
For that reason I wanted to discuss in this document how I think that normals from a normal matrix could be transformed in a mathematically accurate way.
